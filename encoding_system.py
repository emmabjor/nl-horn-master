...
def main():
    ...
    prompt_function = prompts.initial_prompt # ------------- CHANGE PROMPT HERE -------------
    prompt_iteration = "prompt_1" # ------------- CHANGE PROMPT_ITERATION HERE -------------
    adjustment_function = prompts.adjustment_prompt # ------------- CHANGE ADJUSTMENT HERE -------------
    adjustment_iteration = "adjustment_prompt_1" # ------------- CHANGE ADJUSTMENT_ITERATION HERE -------------
    cnf_col_name = "cnf" 
    horn_col_name = "horn" 
